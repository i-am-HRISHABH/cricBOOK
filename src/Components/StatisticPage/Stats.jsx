        ...
        {theTeam.map((p) => {
          return (
            <div className="st-bat-item-box">
              ...
              <div className="st-strike">{p.strike_rate}</div>
        ...
        {theTeam.map((p) => {
          return (
            <div className="st-bowl-item-box">
              ...
              <div className="st-bover">{p.overs}</div>
              <div className="st-bwicket">{p.wickets}</div>
              <div className="st-bruns">{p.runs_given}</div>
              <div className="st-beconomy">{p.economy}</div>
              <div className="st-bstatus">{p.overs > 0 ? "bowled" : "DNB"}</div>
            </div>
          );
        })}
      </div>
